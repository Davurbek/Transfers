namespace Transfers.Dashboard.Api.Domain.Transactions;
...
/// <summary>
/// Read-optimized replica of a transaction. Populated from Main App events.
/// The dashboard never writes business state here directly except via the
/// event consumer.
/// </summary>
public class Transaction
{
    ...
    /// <summary>Business id from the Main App. Indexed, unique.</summary>
    public string TransactionId { get; set; } = string.Empty;

    /// <summary>Remitter id. Indexed.</summary>
