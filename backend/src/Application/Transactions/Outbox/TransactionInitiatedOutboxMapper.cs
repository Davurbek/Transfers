...
public sealed class TransactionInitiatedOutboxMapper : IDomainEventOutboxMapper<TransactionInitiatedEvent>
{
    ...
    public OutboxMessage Map(TransactionInitiatedEvent @event) => new()
    {
