...
public sealed class TransactionUnpausedOutboxMapper : IDomainEventOutboxMapper<TransactionUnpausedEvent>
{
    ...
    public OutboxMessage Map(TransactionUnpausedEvent @event) => new()
    {
