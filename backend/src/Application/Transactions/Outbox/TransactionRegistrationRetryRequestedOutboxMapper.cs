...
public sealed class TransactionRegistrationRetryRequestedOutboxMapper : IDomainEventOutboxMapper<TransactionRegistrationRetryRequestedEvent>
{
    ...
    public OutboxMessage Map(TransactionRegistrationRetryRequestedEvent @event) => new()
    {
