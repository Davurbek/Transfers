...
public sealed class TransactionCreditRetryRequestedOutboxMapper : IDomainEventOutboxMapper<TransactionCreditRetryRequestedEvent>
{
    ...
    public OutboxMessage Map(TransactionCreditRetryRequestedEvent @event) => new()
    {
