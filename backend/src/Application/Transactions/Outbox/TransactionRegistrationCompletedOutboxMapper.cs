...
public sealed class TransactionRegistrationCompletedOutboxMapper : IDomainEventOutboxMapper<TransactionRegistrationCompletedEvent>
{
    ...
    public OutboxMessage Map(TransactionRegistrationCompletedEvent @event) => new()
    {
